...
//    CustomPasswordField.setWidth('200');
//    CustomPasswordField.setHeight('20');

//    /* Define custom event for your widget */
//    CustomPasswordField.addEvent('myEvent');

//    /* Customize existing properties */
//    CustomPasswordField.customizeProperty('test', {
...
//    CustomPasswordField.addLabel({
//        'defaultValue': '',
//        'position': 'top'
//    });

//    /* Set the Design and Styles panels */
//    CustomPasswordField.setPanelStyle({
//        'fClass': true,
//        'text': true,
//        'background': true,
//        'border': true,
...
//    CustomPasswordField.prototype.init = function() {
